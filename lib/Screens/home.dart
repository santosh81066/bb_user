...
class _HomeScreenState extends ConsumerState<HomeScreen> {
        ...
        child: RefreshIndicator(
          ...
          child: CustomScrollView(
            slivers: [
              ...
              SliverToBoxAdapter(
                  child: _buildNewlyAddedProperties(_getFilteredProperties())),
      ...
      children: [
            ...
            child: Center(
              child: isLoading
                  ? Shimmer.fromColors(
                      ...
                      child:
                          Container(height: 45, width: 45, color: Colors.white),
                    )
                  : Text(
                      userName.isNotEmpty
        ...
        Column(
          ...
          children: [
            Text("Welcome back",
                style: GoogleFonts.poppins(
                    color: CoustColors.colrFill, fontSize: 13)),
            isLoading
                ? Shimmer.fromColors(
                    baseColor: Colors.grey[300]!,
                    highlightColor: Colors.grey[100]!,
      ...
      icon: Stack(
        children: [
          const Icon(Icons.notifications_none_rounded,
              size: 28, color: CoustColors.colrFill),
          Positioned(
            right: 0,
            top: 0,
            child: Container(
          ...
          decoration: InputDecoration(
            ...
            suffixIcon: Container(
              ...
              child: Icon(Icons.tune_rounded,
                  color: CoustColors.colrHighlightedText, size: 20),
            ),
            contentPadding:
  ...
  Widget _buildNewlyAddedProperties(List<dynamic> properties) {
    return Padding(
      padding: const EdgeInsets.fromLTRB(20, 10, 20, 15),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          ...
          properties.isNotEmpty
              ...
              : _buildEmptyPropertiesWidget(),
        ],
      ),
    );
  }

  Widget _buildEmptyPropertiesWidget() {
    return Container(
      height: 200,
      decoration: BoxDecoration(
        color: Colors.white,
      ...
      child: Center(
        child: Column(
          ...
          children: [
            Icon(Icons.house_rounded, size: 50, color: Colors.grey[400]),
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 15),
          reviewsState.when(
            loading: () => const _ReviewLoadingSkeleton(),
            error: (error, stackTrace) => Column(
              children: [
                _ReviewErrorWidget(error: error.toString()),
                const SizedBox(height: 10),
                ElevatedButton(
                    onPressed: () => ref.refresh(reviewsProvider),
            ...
            data: (reviews) {
              if (reviews.isEmpty) return const _EmptyReviewsWidget();
              return Column(
                children: [
                  ListView.builder(
                    shrinkWrap: true,
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () => Navigator.of(context)
          .pushNamed('/venue_details', arguments: {'property': property}),
      child: Container(
        width: 160,
        ...
        children: [
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              onPressed: () => Navigator.of(context).pushNamed('/venue_details',
...
class _ReviewCard extends StatelessWidget {
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              TextButton(
                onPressed: () =>
                    _showReviewDialog(context, venueName, venueType, review),
  ...
  void _showReviewDialog(BuildContext context, String venueName,
      String venueType, dynamic review) {
    showDialog(
      context: context,
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(review.reviewText, style: GoogleFonts.poppins(fontSize: 14)),
...
class _ReviewErrorWidget extends StatelessWidget {
  ...
  const _ReviewErrorWidget({required this.error});
...
class _EmptyReviewsWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [
          Icon(Icons.rate_review_outlined, size: 45, color: Colors.grey[400]),
          const SizedBox(height: 10),
